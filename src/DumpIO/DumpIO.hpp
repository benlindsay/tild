...
#ifndef LAMMPSIO_HPP_
#define LAMMPSIO_HPP_
...
class DumpIO {
 ...
 public:
  ...
  void WriteDataFileKA(std::string str_output,
                       std::vector<std::vector<double> >& bb_t_,
                       std::vector<int>& id_t_, std::vector<double>& type_t_,
                       std::vector<std::vector<double> >& pos_t_);
};
